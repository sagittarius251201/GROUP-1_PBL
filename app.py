...
# 8. Cohort
    ...
    if mode=="Time":
        ...
        feats=["Age","MonthlyDisposableIncome","SpendPerServing","HealthConsciousness"]
        k = st.slider("Clusters (K)",2,8,4,key="cohortk")
...
# 11. LTV & Churn
    ...
    fig2=px.histogram(prob,nbins=20,title="Churn Prob",template=tpl); st.plotly_chart(fig2,use_container_width=True)
...
# 13. Chat
    ...
    try:
        ...
        st.warning("ChatGPT unavailable. Add `openai` to requirements.txt and redeploy.")
