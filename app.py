...
st.sidebar.download_button("Download Filtered", df.to_csv(index=False).encode(), "filtered.csv")
if filters:
...
if page=="Visualization":
    ...
    # ... your existing visualization code with template=tpl ...
    ...
    st.plotly_chart(fig,use_container_width=True)
    st.markdown("Choose K at the elbow.")
    ...
    fig=px.bar(city_stats,x="City",y="SpendPerServing",color="SpendPerServing",color_continuous_scale="Viridis",template=tpl)
    st.plotly_chart(fig,use_container_width=True)
    ...
    gloss = {
        ...
        "ConsumptionFrequency":"Drink consumption frequency.",
